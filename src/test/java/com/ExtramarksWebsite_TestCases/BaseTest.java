...
public class BaseTest {
	...
	public void init()
	{
		 ...
		 test=rep.startTest("StudentTest");
	}
	...
	public static void openBrowser(String browser){
		...
		//driver.manage().window().maximize(); -------This is not working when executing with Jenkins
	...
	/*public static DashBoardPage defaultLogin(){
		...
		Object page=loginPage.doLogin(Constants.USERNAME,Constants.PASSWORD);
		DashBoardPage lPage = (DashBoardPage)page;
		return lPage;
	...
	public void defaultLogin(Hashtable<String,String> data)throws InterruptedException
	{
		...
		/*if(!DataUtil.isTestRunnable(xls, "StudentAssessmentTest")  ||  data.get("Runmode").equals("N"))
		{
	...
	/*public void defaultLogin(Hashtable<String, String> data)
	{
		String browser = data.get("Browser");
		openBrowser(browser);
		...
		lp.usernameField.sendKeys("9089089089");
		lp.passwordField.sendKeys("123456");
		lp.Submit_button.click();
			
	}
	
	*/
/*	public static DashBoardPage defaultLogin(Hashtable<String, String> data) throws InterruptedException{
