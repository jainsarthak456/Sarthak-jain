...
public class AssessmentPage extends BasePage
{
	...
	public void SubmittedForEvaluation()
	{
		...
		SubmittedEvaluation.click();
		ViewAnswer.click();
		driver.navigate().back();
		driver.navigate().back();
	}
	
	public void Evaluated() throws IOException
	{
		Evaluated.click();
		ViewAssessment.click();
		ViewEvaluated.click();
		/*Screenshot screenshot = new AShot().shootingStrategy(ShootingStrategies.viewportPasting(1000)).takeScreenshot(driver);
		ImageIO.write(screenshot.getImage(), "PNG", new File("D:\\Website_Report\\Screenshot_1\\"));
*/	
		lp.takeFullScreenshot();
