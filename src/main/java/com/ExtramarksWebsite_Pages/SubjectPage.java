...
public class SubjectPage extends BasePage
{
	...
	@FindBy(xpath="//div[@class='postlogin-card ng-scope']//div[@ng-click]")
	...
	{
		//List<WebElement> MainChap = driver.findElements(By.xpath("//div[@class='postlogin-card ng-scope']//div[@ng-click]"));
		return MainChap;
	}
