...
public class Constants {
	//report path
	public static final String REPORT_PATH = "D:\\AutomationReport\\";
	// Website URL
	public static final String URL = "http://testautomation-www.extramarks.com";
	public static final String SCREENSHOT_PATH = "D:\\AutomationReport\\Screenshots\\";
	public static final String XLS_FILE_PATH = "./src/test/resources/website_data1.xlsx";
	public static final String USERNAME = "1021021021";
	public static final String PASSWORD = "123456";
	
	// driver path
	public static final String CHROME_PATH = "./exefiles/chromedriver.exe";
	public static final String IEDRIVER_PATH = "F:\\drivers\\IEDriverServer.exe";	
